...
public class Task1 {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputHTMLTags = new String(Files.readAllBytes(Paths.get("test.html")));
	...
	public static void findchildUsingLineNumber(String inputHTMLTags, int lineNumber) throws IOException{
